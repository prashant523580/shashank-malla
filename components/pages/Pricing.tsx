...
export default function PricingComponent() {
  return (
    ...
    >
      <h1 className="sm:text-4xl text-3xl text-center py-10 title-font font-bold mb-2 text-black">Pricing</h1>
  <div className="container mx-auto bg-white px-4  py-4">
    <div className="flex flex-col text-center  mb-20">
      {/* <p className="lg:w-2/3 mx-auto leading-relaxed text-white text-base">Banh mi cornhole echo park skateboard authentic crucifix neutra tilde lyft biodiesel artisan direct trade mumblecore 3 wolf moon twee</p> */}
    </div>
