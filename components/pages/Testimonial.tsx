...
export default function Testimonial() {
  ...
  <div className="container px-5 py-4 mx-auto">
    <div className="xl:w-1/2 lg:w-3/4 w-full mx-auto text-center">
      <svg  data-aos="zoom-out" data-aos-duration="1500" xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="inline-block w-8 h-8 text-orange-400 mb-8" viewBox="0 0 975.036 975.036">
      ...
      <p data-aos="zoom-out" data-aos-duration="1500" className="leading-relaxed text-lg text-gray-400">Edison bulb retro cloud bread echo park, helvetica stumptown taiyaki taxidermy 90&apos;s cronut +1 kinfolk. Single-origin coffee ennui shaman taiyaki vape DIY tote bag drinking vinegar cronut adaptogen squid fanny pack vaporware. Man bun next level coloring book skateboard four loko knausgaard..</p>
      <span className="inline-block h-1 w-10 rounded bg-orange-500 mt-8 mb-6"></span>
      <h2 className="text-orange-800 font-medium title-font tracking-wider text-sm">HOLDEN CAULFIELD</h2>
